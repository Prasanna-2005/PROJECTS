...
class Home extends Component {
    ...
    checkLoginStatus = async () => {
        try {
            const response = await fetch('https://cinehive-backend.onrender.com/check-auth', { credentials: 'include' });
    ...
    getMovies = async () => {
        ...
        let url = 'https://cinehive-backend.onrender.com/movie_grid_layout';

        if (filter === 'top-rated') url = 'https://cinehive-backend.onrender.com/movies/top-rated';
        else if (filter === 'language') url = `https://cinehive-backend.onrender.com/movies/lang?language=${selectedLanguage}`;
        else if (filter === 'genre') url = `https://cinehive-backend.onrender.com/movies/genre?genre=${selectedGenre}`;
        else if (filter === 'liked' || filter === 'watchlisted') {
            if (!isLoggedIn) {
                this.setState({ redirectToLogin: true });
                return;
            }
            url = filter === 'liked' ? 'https://cinehive-backend.onrender.com/movies/liked' : 'https://cinehive-backend.onrender.com/movies/watchlists';
        }
